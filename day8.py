...
Operators -->Numeric data (in,float,complex),bool
...
#index() -->fetch the object (position) starts at 0 and ends len(obj) -1
...
print(name[-5:-1]) #stars at -5 and ends at -2
...
print(name[1:-2])
print(name[2:-6])
#observe +ve,+ve ,-ve,-ve all possibilities
...
print(course[::-1]) #it returns the serve of a string
...
name = 'Codegnan'
#name[2] = 'w' #Strings are immutable

#Operations on Strings -->ArithmeticError Indexing,Concatenation,Repitition
print(name * 3)
print('*' * 25) #repetition

#Concatenation --> combinating strings

data = 'jaya' + 'python' + 'database'
print(data)
