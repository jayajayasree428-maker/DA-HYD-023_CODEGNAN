...
Control statements --> control of flow of execution of the program
                   ...
                   --> Repetition stetements(Loops) --> for,while(for with else)
                                                            (while with else)
                   --> Jumping Statements --> break,continue,pass

#Loops --> Loops are helpful for repitition (Automative tasks)
...
#range(stop) --> default 0 ends at step -1
